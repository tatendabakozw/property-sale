...
const ProductDescriptionSection = (props: Props) => {
  return (
    <div className="bg-slate-100 w-full py-16">
      <div className="max-w-7xl mx-auto w-full px-2 grid md:grid-cols-7 grid-cols-2 gap-8">
        <div className="col-span-5 bg-white md:p-8 p-2 rounded-lg w-full shadow flex flex-col space-y-6">
          ...
          <p className="text-slate-700">
            ...
            closets plus washer and dryer. Fully furnished. Elegantly appointed
