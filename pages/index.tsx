      ...
      <main>
        ...
        <div className="bg-white">
          <div className="flex flex-col space-y-2 max-w-7xl px-4 py-16 mx-auto ">
            ...
            <div className="grid md:grid-cols-3 grid-cols-1 gap-8 pt-16">
              <LocationItem span="col-span-1" image={harare} location="Harare" properties="60" />
              <LocationItem span="md:col-span-2 col-span-1" image={bulawayo} location="Bulawayo" properties="12" />
              <LocationItem span="md:col-span-2 col-span-1" image={masvingo} location="Masvingo" properties="13" />
              <LocationItem span="col-span-1" image={mutare} location="Mutare" properties="30" />
            </div>
          </div>
        </div>
      </main>
